...
setup_logging()
app = FastAPI(title="GlucoPlate AI", description="AI-powered recipe generation, personalization, saving, grocery planning, and collaborative cooking API.", version="0.18.0")
...
HTML_SCRIPT_PATHS = ("/static/device-manager.js","/static/native-cook.js","/static/live-cook-rooms.js","/static/live-kitchen-workspace.js","/static/live-cook-media.js","/static/live-video-studio.js","/static/live-cook-transcript.js","/static/live-cook-session-lifecycle.js","/static/live-cook-shared-state.js","/static/native-timers.js","/static/native-ingredients.js","/static/premium-recipe-detail.js","/static/offline-actions.js","/static/firebase-auth.js","/static/firebase-user-data.js","/static/persistent-cook-session.js","/static/profile-personalization.js","/static/pantry-ui.js","/static/shopping-list-ui.js","/static/receipt-import-ui.js","/static/pantry-generation.js","/static/recommendation-ui.js","/static/theme-runtime.js","/static/theme-publish-apply.js","/static/pwa.js")
    ...
    if path.endswith(".html"):
        ...
        for script_path in HTML_SCRIPT_PATHS:
            ...
            if encoded_path not in body and body_marker in body:
                body = body.replace(body_marker, b'<script src="' + encoded_path + b'" defer></script></body>')
...
async def log_requests(request: Request, call_next):
    ...
    response = await call_next(request)
    logger.info("{method} {path} -> {status} ({duration:.1f}ms)", method=request.method, path=request.url.path, status=response.status_code, duration=(time.perf_counter()-start)*1000)
    return response
